...
BUILDDIR="${SSH2ROOT}/build-ios-${PLATFORM}/${ARCH}"

PREFIX="${SSH2ROOT}/install-ios-${PLATFORM}/${ARCH}"
...
${SSH2ROOT}/configure \
    ...
    --with-openssl \
    --disable-shared \
    --with-libssl-prefix=${SSH2ROOT}/../../openssl/bin/openssl-${OPENSSL_VERSION}-${ARCH} > ${out}
