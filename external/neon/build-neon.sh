...
BUILDDIR="${NEONROOT}/build-ios-${PLATFORM}/${ARCH}"

PREFIX="${NEONROOT}/install-ios-${PLATFORM}/${ARCH}"

export PATH="${NEONROOT}/extras/tools/build/bin:${NEONROOT}/contrib/${TARGET}/bin:/usr/bin:/bin:/usr/sbin:/sbin:/usr/local/bin:/usr/X11/bin"

# contains gas-processor.pl
export PATH=$PATH:${NEONROOT}/extras/package/ios/resources
...
${NEONROOT}/configure \
    ...
    --with-libs="${NEONROOT}/../../openssl/bin/openssl-${OPENSSL_VERSION}-${ARCH}" \
