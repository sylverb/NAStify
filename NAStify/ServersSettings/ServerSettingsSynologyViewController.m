//
//  ServerSettingsSynologyViewController.m
//  NAStify
//
        ...
        case 1:
        {
            switch (indexPath.row)
            {
                case 0:
                {
                    ...
                    [textCellAddress setCellDataWithLabelString:NSLocalizedString(@"Address/QuickConnect:",@"")
                                                withText:userAccount.server
                                         withPlaceHolder:NSLocalizedString(@"Hostname/IP/QuickConnect ID",@"")
                                                isSecure:NO
                    ...
                    cell.accessoryType = UITableViewCellAccessoryNone;
                    cell.textLabel.text = NSLocalizedString(@"Address/QuickConnect",nil);
