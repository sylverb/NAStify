...
- (void)listForPath:(FileItem *)folder
{
    ...
    do {
        [[_UPNPdevice contentDirectory] BrowseWithObjectID:_UPNProotID
                                                BrowseFlag:@"BrowseDirectChildren"
                                                    Filter:@"*"
                                             StartingIndex:[@(receivedNumber) stringValue]
                                            RequestedCount:@"0"
        ...
        receivedNumber += [outNumberReturned integerValue];
    ...
    } while ((receivedNumber < [outTotalMatches integerValue]) && ([outNumberReturned integerValue] > 0));
