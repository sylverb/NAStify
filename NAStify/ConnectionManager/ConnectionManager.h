...
typedef NS_OPTIONS(long long, CMSupportedFeaturesMask) {
    ...
    CMSupportedFeaturesMaskDeleteCancel     = 0x0000000000000004,
    CMSupportedFeaturesMaskFolderCreate     = 0x0000000000000008,
    CMSupportedFeaturesMaskFileRename       = 0x0000000000000010,
    CMSupportedFeaturesMaskFolderRename     = 0x0000000000000020,
    CMSupportedFeaturesMaskFileMove         = 0x0000000000000040,
    CMSupportedFeaturesMaskFolderMove       = 0x0000000000000080,
    CMSupportedFeaturesMaskMoveCancel       = 0x0000000000000100,
    CMSupportedFeaturesMaskFileCopy         = 0x0000000000000200,
    CMSupportedFeaturesMaskFolderCopy       = 0x0000000000000400,
    CMSupportedFeaturesMaskCopyCancel       = 0x0000000000000800,
    CMSupportedFeaturesMaskCompress         = 0x0000000000001000,
    CMSupportedFeaturesMaskCompressCancel   = 0x0000000000002000,
    CMSupportedFeaturesMaskExtract          = 0x0000000000004000,
    CMSupportedFeaturesMaskExtractMultiple  = 0x0000000000008000,
    CMSupportedFeaturesMaskExtractCancel    = 0x0000000000010000,
    CMSupportedFeaturesMaskEject            = 0x0000000000020000,
    CMSupportedFeaturesMaskFileDownload     = 0x0000000000040000,
    CMSupportedFeaturesMaskDownloadCancel   = 0x0000000000080000,
    CMSupportedFeaturesMaskFileUpload       = 0x0000000000100000,
    CMSupportedFeaturesMaskUploadCancel     = 0x0000000000200000,
    CMSupportedFeaturesMaskQTPlayer         = 0x0000000000400000,
    CMSupportedFeaturesMaskVLCPlayer        = 0x0000000000800000,
    CMSupportedFeaturesMaskVideoSeek        = 0x0000000001000000,
    CMSupportedFeaturesMaskAirPlay          = 0x0000000002000000,
    CMSupportedFeaturesMaskOpenIn           = 0x0000000004000000,
    CMSupportedFeaturesMaskSearch           = 0x0000000008000000,
    CMSupportedFeaturesMaskSearchCancel     = 0x0000000010000000,
